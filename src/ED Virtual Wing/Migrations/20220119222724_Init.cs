...
namespace ED_Virtual_Wing.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Commander_CommanderLocation_LocationId",
                        column: x => x.LocationId,
                        principalTable: "CommanderLocation",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commander_LocationId",
                table: "Commander",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Commander_TargetId",
                table: "Commander",
                column: "TargetId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Commander_CommanderTarget_TargetId",
                table: "Commander",
                column: "TargetId",
                principalTable: "CommanderTarget",
                principalColumn: "Id");
        }
